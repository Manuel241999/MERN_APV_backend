...
<p>Hola ${nombre},</p>
<p>¡Tu cuenta en APV está lista para ser verificada!</p>
<p>Para completar el proceso, simplemente haz clic en el siguiente enlace:</p>
<p><a href="${process.env.FRONTEND_URL}/confirmar/${token}" class="text-blue-500 underline">Comprobar Cuenta</a></p>
